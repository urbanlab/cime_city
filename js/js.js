...
var overlays = {
	...
	"Jardins collectifs de la ville":jardinscoll,
	"<span id='contribs'>Atelier du 14 dec. 2020</span>":contribs,
};
...
var orthodata = $.ajax({
	...
	success: function(data){
		L.geoJSON(orthodata.responseJSON).addTo(ortho)
	}
})
...
var lieuxsurfaciques = $.ajax({
	url: 'https://download.data.grandlyon.com/wfs/grandlyon?SERVICE=WFS&VERSION=2.0.0&request=GetFeature&typename=adr_voie_lieu.adrlieusurf&outputFormat=application/json; subtype=geojson&SRSNAME=EPSG:4171&startIndex=0&count=300',
	dataType: 'json',
	success: function(data){
...
var pluviometrie = $.ajax({
	url: 'https://download.data.grandlyon.com/wfs/grandlyon?SERVICE=WFS&VERSION=2.0.0&request=GetFeature&typename=eau_general.eausitepluvio&outputFormat=application/json; subtype=geojson&SRSNAME=EPSG:4171',
	dataType: 'json',
	success: function(data){
